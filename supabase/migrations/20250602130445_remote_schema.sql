...
create policy "認証済みユーザーの操作(すべて) 1yj3o2d_0"
on "storage"."objects"
as permissive
for insert
to authenticated
with check ((bucket_id = 'problem-img'::text));


create policy "認証済みユーザーの操作(すべて) 1yj3o2d_1"
on "storage"."objects"
as permissive
for select
to authenticated
using ((bucket_id = 'problem-img'::text));


create policy "認証済みユーザーの操作(すべて) 1yj3o2d_2"
on "storage"."objects"
as permissive
for delete
to authenticated
...
create policy "認証済みユーザーの操作(すべて) 1yj3o2d_3"
on "storage"."objects"
as permissive
for update
to authenticated
